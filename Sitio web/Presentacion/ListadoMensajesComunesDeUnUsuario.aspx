<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListadoMensajesComunesDeUnUsuario.aspx.cs" Inherits="ListadoMensajesComunesDeUnUsuario" %>
    ...
    <div>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="style1">
                    LISTADO DE MENSAJES COMUNES DE UN USUARIO&nbsp;</td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="style1">
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td class="style6">
                                <asp:Label ID="lblErrorDDLTipoMensajes" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="style4">
